...
cat ./docker-compose-faker.yaml \
    ...
    | sed "s|SPRING_KAFKA_SCHEMA_PASS__|$SPRING_KAFKA_SCHEMA_PASS|g" > rendered_docker_compose-faker.yaml

docker-compose -f rendered_docker_compose-faker.yaml up