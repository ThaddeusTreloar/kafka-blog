...
public class KafkaEnv {
    ...
    public static String SPRING_KAFKA_API_KEY_ENV = "KAFKA_API_KEY";
    public static String SPRING_KAFKA_API_SECRET_ENV = "KAFKA_API_SECRET";
    public static String SPRING_KAFKA_BOOTSTRAP_SERVERS_ENV = "KAFKA_BOOTSTRAP_SERVERS";
    public static String SPRING_KAFKA_SCHEMA_REGISTRY_URL_ENV = "KAFKA_SCHEMA_REGISTRY_URL";
    public static String SPRING_KAFKA_SCHEMA_USER_ENV = "KAFKA_SCHEMA_USER";
    public static String SPRING_KAFKA_SCHEMA_PASS_ENV = "KAFKA_SCHEMA_PASS";
    ...
    public Properties intoConfigMap() {
        ...
        map.put(StreamsConfig.SECURITY_PROTOCOL_CONFIG, "SASL_SSL");
